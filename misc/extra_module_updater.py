...
async def unified_update_handler(bot: BOT, message: Message):
    ...
    try:
        ...
        if local_date == remote_date:
            ...
            warning_text = f"<b>WARNING:</b> <blockquote>Update may require reinstalling the requirements. <a href='https://github.com/R0Xofficial/PlainUB-Extras/blob/main/UPDATE_INFO.md'>READ MORE</a></blockquote>"
